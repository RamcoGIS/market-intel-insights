...
const Index = () => {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-blue-100 w-full p-4">
      <div className="text-center max-w-2xl px-4 sm:px-6">
        <h1 className="text-3xl sm:text-4xl font-bold mb-4 text-brand-dark">Welcome to MarketIntel AI</h1>
